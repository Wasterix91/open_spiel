...
for ep in progress:
    ...
    # Letzter Trainingsschritt für alle Agenten
    for pid in range(4):
        agents[pid].step(time_step, [0])  # Dummy für legales Action-Format
        returns[pid].append(time_step.rewards[pid])

    # Winrate-Tracking: hat Spieler 0 gewonnen?
