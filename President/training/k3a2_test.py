# -*- coding: utf-8 -*-
# President/training/k3a2_test.py — DQN Snapshot-Selfplay (1 Learner + 3 Sparring)
# Fixes:
...
#  - Import auf dqn_agent statt dqn_agent_old_new
...
def main():
    ...
    learner = dqn.DQNAgent(state_size=state_size, num_actions=A, config=dqn_cfg, device=CONFIG["DEVICE"])
