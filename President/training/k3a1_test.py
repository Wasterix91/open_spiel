...
def main():
    ...
    for ep in range(1, CONFIG["EPISODES"] + 1):
        ...
        # Für Seats != LEARNER_SEAT vor der Episode festlegen, ob aktuelle Policy oder Snapshot genutzt wird
        seat_actor = {}
        ...
        # Episodenende: Finals auf die letzte Learner-Transition addieren + done markieren
